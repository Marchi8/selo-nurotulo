...
// import AboutBG1A from '../src/AboutBG1A.svg';
import BGAbout1 from '../src/BGAbout1.png';
import BGAboutBottomDots from '../src/BGAboutBottomDots.png';
import BGAboutBottomLeft from '../src/BGAboutBottomLeft.png';
import BGAboutTopDots from '../src/BGAboutTopDots.png';
...
function App() {
  ...
  const getProduct = async () => {
    await axios
      .get(`https://api.nurotulo.app/api:P0c5c7Xy/product/${gtin.substring(2)}`)
      .then((res) => {
    ...
    for (const ean of related) {
      try {
        const response = await axios.get(
          `https://api.nurotulo.app/api:P0c5c7Xy/product/${ean}`
        );
        ...
        {apiProduct.photo ? (
          <div className="container">
            <div className="contentContainer">
              ...
              <div className="productContainer">
                ...
                <div className="relatedProductsContainer">
                  <p className="relatedProductsTitle">
                    Veja outros produtos similares da própria MARCA
                  </p>
                  ...
                  <div className="relatedProducts">
                    {relatedProducts.length
                      ? relatedProducts.map((product, index) => (
                          <button
                            onClick={() => handleClick(product.ean)}
                            key={index}
                  ...
                  <button
                    onClick={() => window.open(apiProduct.site, "_blank")}
            ...
            <div className="aboutContainer">
              ...
              {/* <img src={AboutBG2} alt="" style={{position:'absolute', right:0}}/> */}

              <div className="aprovedAbout">
                <img src={AprovedImg} alt="" />
                <h4 className="">
                  Este RÓTULO passou por curadoria referente às boas práticas de
                  rotulagem, conforme legislação vigente, e foi APROVADO.
                </h4>
              </div>
              ...
              <div className="esgAbout">
                ...
                <h4 className="">
                  O Selo ESG de Integridade do Rótulo é um certificado de
              ...
              <div className="dowloandAbout">
                ...
                <div className="downlaodButtonsContainer">
                  <button
                    onClick={() =>
                      window.open(
                        "https://apps.apple.com/br/app/nur%C3%B3tulo/id1522091609",
                        "_blank"
                      )
                    }
                  ...
                  <button
                    onClick={() =>
                      window.open(
                        "https://play.google.com/store/apps/details?id=br.com.nurotulo.mobile&hl=pt_BR&gl=US",
                        "_blank"
                      )
                    }
              ...
              <img className="BGAboutTopDots" src={BGAboutTopDots} alt="" />
              <img className="BGAboutBottomDots" src={BGAboutBottomDots} alt="" />
               {/* <img className="BGAbout1" src={BGAbout1} alt="" /> */}
          
              <img className="BGAbout1" src={BGAbout1} alt="" />
              <img className="BGAboutBottom" src={BGAboutBottomLeft} alt="" />
            </div>
          </div>
        ) : (
          <LoadingSpinner />
